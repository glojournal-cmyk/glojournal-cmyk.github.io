...
const chemistryEnabled=selectorTail.includes('let ranked=RQ(t,e,W);return ranked.slice(0,Math.min(ranked.length,W+6))');
...
if(!chemistryEnabled) failures.push({type:"runtime-not-using-adaptive-composer"});
